...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="/home/saw/droidup/TienKung-Lab/legged_lab/assets/e1_12dof/mjcf/E1_12dof.xml", help="Path to the MJCF/XML model file")
