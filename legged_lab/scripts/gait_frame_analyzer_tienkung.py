...
class TxtGaitAnalyzer:
    ...
    def apply_current_frame(self):
        ...
        # 你的 TXT 实际前 26 维是位置信息 (20 DOF)：
        # [0:3] Root Pos, [3:6] Euler XYZ, [6:26] Joint Pos
        ...
        # 3. 提取 20 个关节的角度 [6:26]
        self.data.qpos[7:27] = frame_data[6:26]
...
if __name__ == "__main__":
    ...
    # 修改默认路径为天工 20 DOF 的可能路径，请根据实际情况确认
    parser.add_argument("--xml", type=str, default="/home/saw/droidup/TienKung-Lab/legged_lab/assets/tienkung2_lite/mjcf/tienkung.xml")
