...
"""Configuration for G1 12DOF robots (using E1's stiffness and damping)."""
...
G1_12DOF_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{ISAAC_ASSET_DIR}/g1_12dof/g1_12dof.urdf", 
