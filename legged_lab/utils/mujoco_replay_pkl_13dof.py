...
XML_JOINT_NAMES = [
    ...
    # Waist (1) - 确保这里的名字与你 XML 里的腰部关节名一致
    'waist_yaw_joint'
]
# ==========================================================
...
def play_motion(xml_path, motion_file):
    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        while viewer.is_running():
            ...
            # 3. 设置关节角度 (截取前 num_joints_xml 个，防止 PKL 维度超出)
...
if __name__ == "__main__":
    ...
    # 记得将这里的 default 改成你 13dof 机器人的 xml 路径
    parser.add_argument("--xml", type=str, default="/home/saw/droidup/TienKung-Lab/legged_lab/assets/e1_13dof/mjcf/E1_13dof.xml")
