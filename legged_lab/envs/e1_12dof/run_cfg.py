...
# All rights reserved.
#
# Copyright (c) 2025-2026, The E1_12DOF_-Lab Project Developers.
# All rights reserved.
# Modifications are licensed under the BSD-3-Clause license.
#
# This file contains code derived from the RSL-RL, Isaac Lab, and Legged Lab Projects,
# with additional modifications by the E1_12DOF_-Lab Project,
        ...
        params={
            "asset_cfg": SceneEntityCfg(
                ...
                joint_names=[
                    ...
                    ".*elbow_joint",  # 注意：你的 URDF 叫 left_elbow_joint，没有 pitch
                ],
            )
        },
    )
    ...
    joint_deviation_legs = RewTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg(
                ...
                joint_names=[
                    ".*hip_pitch_joint",
                    ".*knee_joint",      # 注意：你的 URDF 叫 left_knee_joint，没有 pitch
                    ".*ankle_pitch_joint",
                    ".*ankle_roll_joint",
                ],
            )
...
class E1_12DOF_RunFlatEnvCfg:
    ...
    robot: RobotCfg = RobotCfg(
        ...
        action_scale=0.25,
        terminate_contacts_body_names=[".*knee_link", ".*shoulder_roll_link", ".*elbow_link", "pelvis"], # 修改这里
        feet_body_names=[".*ankle_roll_link"], # 修改这里
    )
    reward = E1_12DOF_RewardCfg()
    gait = GaitCfg()
...
@configclass
class E1_12DOF_RunAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/e1_12dof/datasets/motion_amp_expert/small_forward_boy.txt"]
