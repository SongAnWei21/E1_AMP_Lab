...
# All rights reserved.
#
# Copyright (c) 2025-2026, The E1_12DOF-Lab Project Developers.
# All rights reserved.
# Modifications are licensed under the BSD-3-Clause license.
#
# This file contains code derived from the RSL-RL, Isaac Lab, and Legged Lab Projects,
# with additional modifications by the E1_12DOF-Lab Project,
...
from legged_lab.envs.e1_12dof.run_cfg import E1_12DOF_RunFlatEnvCfg
from legged_lab.envs.e1_12dof.walk_cfg import E1_12DOF_WalkFlatEnvCfg
...
class E1_12DOF_Env(VecEnv):
    def __init__(
        self,
        cfg: (
            E1_12DOF_RunFlatEnvCfg
    ...
    #     # Critic 观测：Actor观测 + 步态时钟(6维) + 特权信息(线速度、足端接触)
