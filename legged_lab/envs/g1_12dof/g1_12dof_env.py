...
# 导入之前配置好的 G1_12DOF 配置文件
from legged_lab.envs.g1_12dof.walk_cfg import G1_12DOFWalkFlatEnvCfg
...
class G1_12DOFEnv(VecEnv):
    def __init__(
        self,
        cfg: G1_12DOFWalkFlatEnvCfg,
        headless,
    ):
        self.cfg: G1_12DOFWalkFlatEnvCfg
    ...
    def init_buffers(self):
        ...
        # 🔴 替换为 G1 的腿部关节名称 (严格按照运动学链顺序：pitch -> roll -> yaw -> knee -> ankle_pitch -> ankle_roll)
