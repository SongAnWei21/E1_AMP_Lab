...
# All rights reserved.
#
# Copyright (c) 2025-2026, The E1_21DOF_-Lab Project Developers.
# All rights reserved.
# Modifications are licensed under the BSD-3-Clause license.
#
# This file contains code derived from the RSL-RL, Isaac Lab, and Legged Lab Projects,
# with additional modifications by the E1_21DOF_-Lab Project,
...
@configclass
class E1_21DOF_RunAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/e1_21dof/datasets/motion_amp_expert/small_forward_boy.txt"]
