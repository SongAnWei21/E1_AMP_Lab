...
from legged_lab.assets.tienkung2_lite import TIENKUNG12DOF_CFG
...
@configclass
class TienKung12DOFWalkFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/tienkung_12dof/datasets/motion_visualization/small_forward_boy.txt"]
    device: str = "cuda:0"
    scene: BaseSceneCfg = BaseSceneCfg(
        max_episode_length_s=20.0,
        num_envs=4096,
        env_spacing=2.5,
        robot=TIENKUNG12DOF_CFG,  # 使用修改后的配置
...
@configclass
class TienKung12DOFWalkAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    experiment_name = "tienkung_12dof_walk"  # 修改了实验名称
    run_name = ""
    logger = "tensorboard"
    neptune_project = "tienkung_12dof_walk"
    wandb_project = "tienkung_12dof_walk"
    resume = False
    load_run = ".*"
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/tienkung_12dof/datasets/motion_amp_expert/small_forward_boy.txt"]
