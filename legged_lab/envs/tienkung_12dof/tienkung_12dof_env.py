...
from legged_lab.envs.tienkung_12dof.walk_cfg import TienKung12DOFWalkFlatEnvCfg
...
class TienKung12DOFEnv(VecEnv):
    ...
    def init_buffers(self):
        ...
        # ⚠️ 删除了 left_arm_ids 和 right_arm_ids
        ...
        # ⚠️ 删除了 left_arm_local_vec 和 right_arm_local_vec
    ...
    def compute_current_observations(self):
        ...
        current_actor_obs = torch.cat(
            [
                ...
                joint_pos * self.obs_scales.joint_pos,  # 12 (原来是20)
                joint_vel * self.obs_scales.joint_vel,  # 12 (原来是20)
                action * self.obs_scales.actions,  # 12 (原来是20)
    ...
    def get_amp_obs_for_expert_trans(self):
        """Gets amp obs from policy (12 DOF 双足版本)"""
        ...
        # 拼接返回: [左腿位置, 右腿位置, 左腿速度, 右腿速度, 左脚坐标, 右脚坐标] -> 总计 30 维
        return torch.cat(
            (
